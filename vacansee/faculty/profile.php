...
<head>
    ...
    <title>Profile Settings - VACANSEE Faculty</title>
...
<body class="dashboard-page">
            ...
            <div class="container profile-container">
                ...
                <div class="profile-header">
                    ...
                    <div class="profile-info">
                        ...
                        <p>Faculty | <?php echo htmlspecialchars($user['department']); ?></p>
                    </div>
                </div>
    ...
    <script>
        ...
        function validatePasswordForm() {
            ...
            changePasswordBtn.disabled = !(currentPassword && newPassword && confirmPassword && strength === 100 && match);
        }
